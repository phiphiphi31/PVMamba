...
Backbone_VisionMamba: nn.Module = build.spatialmamba.Backbone_VisionMamba

@MODELS_MMSEG.register_module()
@MODELS_MMDET.register_module()
class MM_VisionMamba(BaseModule, Backbone_VisionMamba):
    def __init__(self, *args, **kwargs):
        BaseModule.__init__(self)
        Backbone_VisionMamba.__init__(self, *args, **kwargs)
